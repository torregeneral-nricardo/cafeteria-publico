            ...
            <form action="controllers/AuthController.php?action=login" method="POST" class="space-y-5">
                ...
                <div class="space-y-1">
                    ...
                    <div class="flex justify-between pt-1">
                        <a href="controllers/AuthController.php?action=recuperar" class="text-xs text-gold-600 hover:text-gold-700 hover:underline transition-colors">
                            ¿Olvidaste tu contraseña?
                        </a>
                        <a href="controllers/AuthController.php?action=registro" class="text-xs text-gray-600 hover:text-gray-800 hover:underline transition-colors">
                            Crear nueva cuenta
                        </a>
                    </div>
                </div>
